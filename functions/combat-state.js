/**
 * Cloudflare Pages Function — Combat Roster State
 * Handles GET (read) and POST (write) for the per-character miscast roster.
 *
 * Requires a KV namespace binding named COMBAT_STATE.
 * (You can reuse the same KV namespace as the RP Calendar, or make a new one.)
 */
